  ...
  render() {
    ...
    return (
      <main className="mx-auto flex min-h-screen max-w-lg flex-col items-center justify-center gap-4 px-6 text-center">
        ...
        <p className="text-sm text-muted-foreground">Reload the Workshop to start again.</p>
        <button className="rounded-md bg-primary px-4 py-2 text-sm" onClick={() => location.reload()}>
          Reload
        </button>
      </main>
    )
