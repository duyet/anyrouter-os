/**
 * Inline AnyRouter "AR" mark. `fill="currentColor"` so it follows the theme —
 * an <img> of the brand SVG cannot, and would go dark-on-dark in `.dark`.
 */
export default function AnyRouterMark({ className }: { className?: string }) {
  return (
    <svg
