// Stand-in for the `cloudflare:workers` module, which only exists inside workerd. Copied from
// mcp-shared's identical stub (see its comment) rather than shared, since it's a tiny fixture, not
// runtime code.
//
